...
<div class="update-schedule-page">
  ...
  <form method="post" action="{{ route('horarios.update') }}" class="form-card">
    ...
    <div class="form-section">
      ...
      <script>
        // Init custom select for templates (update form)
        (function(){
          function initCustomSelect(id){
            ...
            Array.from(sel.options).forEach(opt => {
              ...
              item.addEventListener('click', function(){ sel.value = this.dataset.value; sel.dispatchEvent(new Event('change',{bubbles:true})); disp.textContent = this.textContent; list.classList.remove('open'); });
              list.appendChild(item);
            });
            wrapper.appendChild(list);
            custom.addEventListener('click', function(){ list.classList.toggle('open'); });
